                ...
                <div className="grid grid-cols-2 gap-8 sm:gap-16 sm:grid-cols-2">
                    <div>
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 font-medium">
                            <li className="mb-3">
                                <a href="https://github.com/abhishekpatil4/gmail-support-bot" className="hover:underline">Source Code</a>
                            </li>
                            <li className="mb-3">
                                <a href="https://replit.com/@abishkpatil/gmail-support-bot" className="hover:underline">Replit</a>
                            </li>
                            <li className="mb-3">
